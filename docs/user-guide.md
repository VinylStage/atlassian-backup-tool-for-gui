...
2. 마우스 커서가 **좌우 화살표(↔)** 모양으로 변합니다
3. **클릭한 채로 좌우로 드래그**합니다
4. 원하는 너비에서 마우스를 놓습니다
...
4. **"Start Backup"** 버튼을 클릭합니다
5. 진행률이 표시됩니다
6. 완료되면 ZIP 파일이 다운로드됩니다
...
**A:** 페이지 수가 많거나 첨부파일이 클수록 시간이 오래 걸립니다. 진행률 표시를 확인하며 기다려 주세요.
